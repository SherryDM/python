...
sys.path.append("E:\Mydocuments\coders\python\my")
...
parser.add_argument('--sample_interval', type=int, default=30, help='interval betwen image samples')##取样间隔
...
for epoch in range(opt.n_epochs):
    ...
    for i, ((imgs_A, labels_A), (imgs_B, labels_B)) in enumerate(zip(dataloader_A, dataloader_B)):
        ...
        if batches_done % opt.sample_interval == 0:
            ...
            sample = torch.cat((imgs_A.data[3], fake_B.data[3], imgs_B.data[3]), -2)##样本拼接（A,F_B,B）
