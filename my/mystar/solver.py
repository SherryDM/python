    ...
    def train_multi(self):
        ...
        for i in range(start_iters, self.num_iters):
            for dataset in ['CelebA', 'RaFD']:
                ...
                # sample_path=os.path.join(self.sample_dir,'{}-fake.jpg'.format(i+1))#####
                # save_image(self.denorm(x_fake),sample_path,nrow=1,padding=0)       #####
                # print('save fake image into {}...'.format(sample_path))            #####
