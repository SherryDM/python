...
if __name__ == '__main__':
    ...
    parser.add_argument('--rafd_crop_size', type=int, default=900, help='crop size for the RaFD dataset')#裁剪rafd人脸
    ...
    # Directories.
    parser.add_argument('--celeba_image_dir', type=str, default='/data/dm/data/BU_3DFE/CelebA')
    parser.add_argument('--attr_path', type=str, default='/data/dm/data/BU_3DFE/label_all.txt')
    parser.add_argument('--rafd_image_dir', type=str, default='/data/dm/data/RAF_DB/train')
